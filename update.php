        ...
        if(isset($_SESSION['userid'])){
            ...
            <div class="bbox">
                <form action="includes/upload.inc.php" method="POST" enctype="multipart/form-data" style="padding: 30px;">
                    <input type="text" name="name" placeholder="Display Name" style="font-size: 15px; border: solid 1px ;padding-top: 8px;padding-bottom: 8px;outline-color: red;" required><br><br>
                    ...
                    elseif (isset($_GET['success'])){
                        ...
                        echo '<p style="color: green;">File Uploaded Successfully<br>(To see your upload, go to home)</p>';
                    }
                }
                echo '</form>
